const Hobbies = () => {
  const hobbies = [
    ...
    },
    {
      ...
      description: 'I am passionate about staying updated with the latest technologies and frameworks in the software development world.',
    },
    {
      ...
      description: 'I enjoy solving coding challenges and puzzles to improve my logical thinking and programming skills.',
    },
  ];
